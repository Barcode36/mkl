...
public class Wiadomosci {
    ...
    public Wiadomosci(String id_nadawcy, String temat_wiadomosci, String data, String status_wiadomosci, int id_wiadomosci,String tresc_wiadomosci) {
        ...
        public Wiadomosci(int id_wiadomosci, String id_nadawcy,String temat_wiadomosci,String tresc_wiadomosci,String data,String status_wiadomosci) {
        this.id_wiadomosci = id_wiadomosci;
        this.id_nadawcy = id_nadawcy;
        this.temat_wiadomosci = temat_wiadomosci;
        this.tresc_wiadomosci = tresc_wiadomosci;
    ...
    public Wiadomosci(String id_odbiorcy, String temat_wiadomosci, String data, int id_wiadomosci) {
    ...
    public Wiadomosci(int id_wiadomosci, String id_nadawcy, String id_odbiorcy, String temat_wiadomosci, String tresc_wiadomosci, String status_wiadomosci, String data) {
        this.id_wiadomosci = id_wiadomosci;
        this.id_nadawcy = id_nadawcy;
        this.id_odbiorcy = id_odbiorcy;
        this.temat_wiadomosci = temat_wiadomosci;
