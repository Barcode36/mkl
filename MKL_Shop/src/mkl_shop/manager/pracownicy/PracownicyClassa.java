...
public class PracownicyClassa {
    ...
    public PracownicyClassa(int id_pracownika, String imie_pracownika, String nazwisko_pracownika, String peselpracownika, String telefonpracownika, String rolapracownika, String placowka) {
    ...
    public String getPeselpracownika() {
        return peselpracownika.get();
    }

    public void setPeselpracownika(String value) {
        this.peselpracownika.set(value);
    }
    ...
    public void setPlacowka(String value) {
        this.placowka.set(value);
    }
     @Override
    public String toString() {
        return imie_pracownika.get() + " " + nazwisko_pracownika.get() + ", " + peselpracownika.get() + " " + placowka.get() + "\n Rola: " + rolapracownika.get() + "\n Telefon: " + telefonpracownika.get();
    }
